...
Match = (function () {
	class Match {
		constructor(_at_start_in_before, _at_start_in_after, _at_length) {
...
find_match = function (
	...
	for (
		...
		start_in_before <= end_in_before ? _i < end_in_before : _i > end_in_before;
